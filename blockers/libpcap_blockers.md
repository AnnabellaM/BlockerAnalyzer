...
**Coverage sources:** `coverage/libpcap/cmplog.cov`, `coverage/libpcap/n4.cov`  
...
- **Statement**: `handlep->poll_timeout = 1;	/* don't block for very long */`
- **Blocked side**: True (0 hits in `cmplog`)
...
- **Statement**: `#define RARP_SRCADDR_OFFSET 14`
...
- **Statement**: `* These are offsets for the MTP2 fields.`
...
- **Statement**: `* This is the offset of the first byte after the ATM pseudo_header,`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `* These are offsets for the MTP3 fields.`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `if (pcap_parse(scanner, &cstate) != 0) {`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `return gen_cmp_ne(cstate, OR_PREVLINKHDR, SUNATM_PKT_BEGIN_POS, BPF_H, 0xFF00);`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `if (! ((q.addr == Q_HOST || q.addr == Q_DEFAULT) && q.proto == Q_LINK))`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `case DLT_NETANALYZER_TRANSPARENT:`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `case DLT_JUNIPER_MONITOR:`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 13,000, n4: 14,200)
...
- **Statement**: `case DLT_JUNIPER_SRX_E2E:`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `case DLT_JUNIPER_PPPOE_ATM:`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 13,100, n4: 14,200)
...
- **Statement**: `case DLT_JUNIPER_ATM_CEMIC:`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 13,100, n4: 14,200)
- **Flip strength**: 84 (blocked side hit 84× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `q.addr == Q_NET ? "net <IPv4 address>" :`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `case DLT_JUNIPER_PPP:`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 13,100, n4: 14,200)
...
- **Statement**: `case DLT_DSA_TAG_DSA:`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 13,100, n4: 14,200)
...
- **Statement**: `case DLT_DSA_TAG_BRCM:`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 13,100, n4: 14,200)
...
- **Statement**: `if (s == NULL && q.addr == Q_NET) {`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `case DLT_JUNIPER_CHDLC:`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 13,100, n4: 14,200)
...
- **Statement**: `if (q.addr != Q_HOST && q.addr != Q_DEFAULT)`
- **Blocked side**: False (0 hits in `n4`)
...
- **Statement**: `case DLT_JUNIPER_FRELAY:`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `* Error.  If it's not EINTR, report it.`
- **Blocked side**: True (0 hits in `cmplog`)
...
- **Statement**: `* Either monitor mode has been turned on for`
- **Blocked side**: True (0 hits in `cmplog`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 19 (blocked side hit 19× by `n4`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `* directly afterwards, instead it should be used as an argument to gen_and(),`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
...
- **Statement**: `if (pcap_nametoport(name, &port, &real_proto) == 0)`
- **Blocked side**: False (0 hits in `n4`)
...
- **Statement**: `#define IP6_HDRLEN 40`
- **Blocked side**: False (0 hits in `n4`)
...
- **Statement**: `cstate->off_linkpl.constant_part = 12;`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 12 (blocked side hit 12× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `* That offset isn't variable, there's no variable part,`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 91,700, n4: 815,000)
- **Flip strength**: 11 (blocked side hit 11× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `* This generates code to check both for the`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 11 (blocked side hit 11× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `cstate->off_linkpl.constant_part = OFFSET_NOT_SET;`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
...
- **Statement**: `* loading the length of the AVS header.`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 9 (blocked side hit 9× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `s_roundup = new_stmt(cstate, BPF_LD|BPF_MEM);`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 91,700, n4: 815,000)
- **Flip strength**: 8 (blocked side hit 8× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `* Converge this to "(ld|ldh|ldb) [x + k]", where 'k' holds the`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 8 (blocked side hit 8× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `#define	ARCTYPE_ATALK		221	/* Appletalk */`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `static struct block *gen_msg_abbrev(compiler_state_t *, const uint8_t);`
- **Blocked side**: False (0 hits in `n4`)
...
- **Statement**: `* The maximum possible value can also be used as a bit mask because the`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `* Value passed to gen_load_a() to indicate what the offset argument`
- **Blocked side**: False (0 hits in `n4`)
...
- **Statement**: `OR_LINKTYPE,		/* link-layer type */`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 2,990, n4: 8,710)
- **Flip strength**: 6 (blocked side hit 6× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `if (cstate->linktype >= DLT_HIGH_MATCHING_MIN &&`
- **Blocked side**: False (0 hits in `n4`)
...
- **Statement**: `#define FIELD_BEGIN_POS 4`
- **Blocked side**: False (0 hits in `n4`)
...
- **Statement**: `u_int src_off, dst_off;`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `const bpf_u_int32 constpart, const struct arth *arthpart,`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 4 (blocked side hit 4× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `case DLT_PRISM_HEADER:`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 206, n4: 3)
- **Flip strength**: 4 (blocked side hit 4× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `if (q.proto == Q_DEFAULT)`
- **Blocked side**: False (0 hits in `n4`)
...
- **Statement**: `* we don't have to worry about leaking memory.  It's probably`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `memcpy(hdrp->sll2_addr, sll->sll_addr, SLL_ADDRLEN);`
- **Blocked side**: True (0 hits in `cmplog`)
- **Hit side**: False (cmplog: 91,800, n4: 815,000)
- **Flip strength**: 2 (blocked side hit 2× by `n4`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `* A chunk can store any of:`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `* "ARCNET Designer's Handbook" published by Datapoint`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `* for the types, for example, "ms-tp type token".`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 2 (blocked side hit 2× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `const u_int offset, const u_int size)`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 2 (blocked side hit 2× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `case DLT_BACNET_MS_TP:`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 3,000, n4: 8,710)
- **Flip strength**: 2 (blocked side hit 2× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `if (ll_proto <= ETHERMTU) {`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `case DLT_NETANALYZER:`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 208, n4: 3)
- **Flip strength**: 2 (blocked side hit 2× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `#ifdef HAVE_LINUX_NET_TSTAMP_H`
- **Blocked side**: True (0 hits in `cmplog`)
...
- **Statement**: `/* if required build in place the sll header*/`
- **Blocked side**: True (0 hits in `cmplog`)
- **Hit side**: False (cmplog: 91,800, n4: 815,000)
- **Flip strength**: 1 (blocked side hit 1× by `n4`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `* It's guaranteed, at this point, that d is a valid`
- **Blocked side**: True (0 hits in `cmplog`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 1 (blocked side hit 1× by `n4`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `#define SUNATM_DIR_POS		0`
- **Blocked side**: False (0 hits in `n4`)
...
- **Statement**: `#define SUNATM_VPI_POS		1`
- **Blocked side**: False (0 hits in `n4`)
...
- **Statement**: `* For use *ONLY* in routines in this file.`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `* We assume here that the Atheros adapters that insert the`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 91,800, n4: 815,000)
- **Flip strength**: 1 (blocked side hit 1× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `sjset_notsft_datapad->s.k = 0x20;`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 91,800, n4: 815,000)
- **Flip strength**: 1 (blocked side hit 1× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `b0 = gen_atm_prototype(cstate, PT_LLC);`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 91,800, n4: 815,000)
- **Flip strength**: 1 (blocked side hit 1× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `* XXX - should we generate code to check for SNAP?`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `cstate->off_nl = 8;		/* 802.2+SNAP */`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `* is being used and pick out the encapsulated Ethernet type.`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `* PPPo{A,E} and a PPP protocol of IP and....`
- **Blocked side**: True (0 hits in `n4`)
...
- **Statement**: `cstate->off_nl_nosnap = 21;	/* 802.3+802.2 */`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 1 (blocked side hit 1× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `* - the variable part of an absolute offset (either absent or already`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 1 (blocked side hit 1× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `* Generate code to load the length of the radio header into`
- **Blocked side**: True (0 hits in `n4`)
- **Hit side**: False (cmplog: 101,000, n4: 1,280,000)
- **Flip strength**: 1 (blocked side hit 1× by `cmplog`)
- **Status**: ✅ CONFIRMED INPUT-DEPENDENT
...
- **Statement**: `case DLT_IEEE802_11_RADIO_AVS:`
- **Blocked side**: True (0 hits in `n4`)
